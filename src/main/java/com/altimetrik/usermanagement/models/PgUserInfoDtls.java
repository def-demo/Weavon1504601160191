...
public class PgUserInfoDtls  {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userInfoDtlsId, userInfoMstrId, pgSourceMstr, adId, fullName, highestQualificationHeld, currentJobTitle, pgRequirement, roleId, pgSkillTrackDtls, experienceInYrs, currentEmployer, skypeId, emailId, uniqueId, linkedinUrl, addressLine1, city, zipCode, country, stateName, additionalInfo, twitter, otherDesc, createdBy, createdDt, updatedBy, updatedDt);
  }
